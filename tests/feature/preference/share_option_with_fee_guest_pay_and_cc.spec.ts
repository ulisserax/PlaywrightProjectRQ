...
test.describe.only('Share option with fees - Guest Pay On and Collect Credit Card On',  ()=>{
    ...
    test.only("SM-T1139, SM-T1155, SM-T1158, SM-T1160, SM-T1165, SM-T1166: Requestor shares an option with a Fees, Client's default permissions are set to can set preferences and can award", async({requestEndpoints, optionEndpoints,webActions, homePage, dashboard, search, shareOption,b2eHomePage,b2eBookingPage,b2eOptionsPage})=>{
    ...
    test("SM-T1152, SM-T1155, SM-T1158, SM-T1160, SM-T1165, SM-T1167: Requestor shares an option with Fees, Requestor sets sharing permissions to can set preferences and can award", async({requestEndpoints, optionEndpoints,webActions, homePage, dashboard, search, shareOption})=>{
