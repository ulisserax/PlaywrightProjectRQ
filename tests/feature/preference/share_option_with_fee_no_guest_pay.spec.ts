...
test.describe('Share option with fees - No Guest Pay',  ()=>{
    ...
    test("SM-T1135, SM-T1155, SMT1158 : Requestor shares an option with fees, Client's default permissions are set to can set preferences and can award", async({requestEndpoints, optionEndpoints,webActions, homePage, dashboard, search, shareOption, b2eHomePage, b2eOptionsPage, b2eBookingPage})=>{
        ...
        await b2eOptionsPage.validateOptionPreferenceSelected(first_option_id,ENV.OPTIONS_PREFERENCES.set);
